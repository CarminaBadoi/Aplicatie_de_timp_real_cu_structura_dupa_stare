			...
			local_referinta = 0;
				...
				{		
					...
					case 0:
							...
							SetCtrlAttribute(panelHandle,PANEL_NUMERIC_4,ATTR_VISIBLE,0);
							SetCtrlAttribute(panelHandle,PANEL_NUMERIC_5,ATTR_VISIBLE,0);
							
							//GENERAM SEMNALUL TREAPTA
							
							GetCtrlVal(panelHandle,PANEL_NUMERIC, &local_referinta);
					...
					case 1: 
						...
						SetCtrlAttribute(panelHandle,PANEL_NUMERIC_4,ATTR_VISIBLE,1);
						...
						if (comutare_sin==0){
											...
											GetCtrlVal(panelHandle,PANEL_NUMERIC_3,&A);
											
											// CITIM PERIOADA DE PE INTERFATA GRAFICA
											GetCtrlVal(panelHandle,PANEL_NUMERIC_4,&T);
						}
					...
					case 2: 
						...
						GetCtrlVal(panelHandle,PANEL_NUMERIC_5,&local_a);
								  ...
								  void *callbackData, int eventData1, int eventData2)
{
				...
				{		
					...
					case EVENT_COMMIT:
						...
						GetCtrlVal(panelHandle,PANEL_RING,&selectare_referinta);   
